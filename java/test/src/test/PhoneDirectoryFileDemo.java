...
/**
 * Created by Sudhabindu on 19-Jun-17.
 */
        ...
        if ( ! dataFile.exists() ) {
            ...
            try( Scanner scanner = new Scanner(dataFile) ) {
                ...
                try{
                    ...
                    xmlDoc = docBuilder.parse(new InputSource(new StringReader(data)));
                    ...
                    for(int i = 0; i < children.getLength(); i++){
                        ...
                        Attr attribute;
                        attribute = (Attr)attributes.item(0);
                        name = attribute.getValue();
                        attribute = (Attr)attributes.item(1);
